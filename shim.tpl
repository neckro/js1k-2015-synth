...
<html>
  ...
  <head>
    ...
    <link rel="canonical" href="http://js1k.com/2015-hypetrain/demo/{{ id }}">
    <link rel="shortlink" href="http://js1k.com/{{ id }}">
    <script>
      // GA
    </script>
    <style>
  ...
  <body>
    <header>
      <div>
        ...
        <aside>
          ...
          {{ bytes }} bytes
          &mdash;
          <a href="http://js1k.com/2015-hypetrain/details/{{ id }}">demo details</a>
          &mdash;
          <a href="http://js1k.com/2015-hypetrain/demos">list of demos</a>
          &mdash;
          <a href="http://js1k.com/{{ id }}" title="short link for your mobile devices" rel="nofollow">js1k.com/{{ id }}</a>
    ...
    <script>
      ...
      var TOKEN_CANVAS_SHIM = {{ canvas_shim }};
